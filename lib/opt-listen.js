...
function addListeners() {
	...
	scutReset.addEventListener("click", function (event) {
		pref.set({"shortcut": defaultPreferences.shortcut})
	}, false)
	...
	customStyleSave.addEventListener("click", function (event) {
		document.getElementById("customstyle").value =
			document.getElementById("customstyle").value
					...
					.replace(/;{2,}/g, ";")
					.replace(/\s*\n/g, "\n")
		pref.set({"customstyle": document.getElementById("customstyle").value})
	...
	colorReset.addEventListener("click", function (event) {
		pref.set({"customcolor": defaultPreferences.customcolor})
	}, false)
